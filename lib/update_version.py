...
main = [path.join("src", "gtools.pkg"),
        ...
        path.join("doc", "stata", "gcollapse.sthlp"),
        path.join("doc", "stata", "gcontract.sthlp"),
        path.join("doc", "stata", "gegen.sthlp"),
        path.join("doc", "stata", "gunique.sthlp"),
        path.join("doc", "stata", "gdistinct.sthlp"),
        path.join("doc", "stata", "glevelsof.sthlp"),
        path.join("doc", "stata", "gtoplevelsof.sthlp"),
        path.join("doc", "stata", "gisid.sthlp"),
        path.join("doc", "stata", "hashsort.sthlp"),
        path.join("doc", "stata", "gtools.sthlp"),
