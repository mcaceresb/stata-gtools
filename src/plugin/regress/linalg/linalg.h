...
void gf_regress_dprintf_colmajor  (ST_double *matrix, GT_size k1, GT_size k2, char *name);
void gf_regress_lprintf_colmajor  (GT_size   *matrix, GT_size k1, GT_size k2, char *name);

void gf_regress_linalg_dsyqr      (ST_double *A, GT_size N, ST_double *QR,  GT_size *colix, GT_bool *singular);
void gf_regress_linalg_dsylu      (ST_double *A, GT_size N, ST_double *LU,                  GT_bool *singular);
void gf_regress_linalg_dsyldu     (ST_double *A, GT_size N, ST_double *LDU, GT_size *colix, GT_bool *singular);
void gf_regress_linalg_dcollinear (ST_double *A, GT_size N, ST_double *LDU, GT_size *colix);
...
void gf_regress_linalg_dsymm_colmajor_ix     (ST_double *A, ST_double *B, ST_double *C,               GT_size *colix, GT_size N,    GT_size K);
void gf_regress_linalg_dsymm_wcolmajor_ix    (ST_double *A, ST_double *B, ST_double *C, ST_double *w, GT_size *colix, GT_size N,    GT_size K);
...
void gf_regress_linalg_error_colmajor_ix1    (ST_double *y, ST_double *A, ST_double *b,               ST_double *c, GT_size *colix, GT_size N, GT_size K);
void gf_regress_linalg_error_wcolmajor_ix1   (ST_double *y, ST_double *A, ST_double *b, ST_double *w, ST_double *c, GT_size *colix, GT_size N, GT_size K);
